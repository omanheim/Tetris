...
public class lTet extends Tetromino {
	...
	final private Color color = Color.ORANGE;
	
	public lTet(Point[] start, int CW, int CH) {
		super(start, CW, CH);
	}
		
	public lTet(int CW, int CH) {
		super(new Point[] { new Point(60, 20),new Point(80, 20), 
				new Point(100, 20), new Point(100, 0) }, CW, CH);
	}
